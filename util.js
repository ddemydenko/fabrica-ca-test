...
function getAdmin(client, userOrg) {
	const keyPath = path.join(__dirname, util.format('../fabric-ca/data/orgs/%s/admin/msp/keystore', userOrg));
	...
	const certPath = path.join(__dirname, util.format('../fabric-ca/data/orgs/%s/admin/msp/signcerts', userOrg));
